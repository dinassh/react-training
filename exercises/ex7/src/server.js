...
const getCounter = ({ firstName, lastName }) => {
  return (accumulator, currentValue) => currentValue.firstName === firstName && currentValue.lastName === lastName ? ++accumulator : accumulator;
}
